    ...
    <div class="container main">
      ...
      <!-- </el-affix> -->
        ...
        <div class="center" v-if="contentsTime.result">
          <div>
            <div class="content" v-for="(item,i) in contentsTime.result" :key="i">
 ...
 name:'Home',
    ...
    const getlist=()=>{
      getContents(pagination).then(data=>{
        ...
        // console.log(contentsTime.value);
        })
    }
    getlist()
    ...
    getHot().then(data=>{
      if(data.meta.status!==200) return ElMessage.error('获取热门帖子失败')
      contentHot.value=data.data
      // console.log(contentHot.value);
    })
