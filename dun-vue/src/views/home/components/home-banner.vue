    ...
    <div class="container">
      ...
      <div class="home_user"  v-if="user_states">
         <div class="user_info_content">
            ...
            <RouterLink to="/member" class="user_word">{{$store.state.user.profile.nickname||$store.state.user.profile.username}}</RouterLink>
            <!-- 个人信息 -->
          ...
          <div class="user_info_bottom" >
            ...
            <div class="user_info_bottom_ba2">
              <RouterLink class="user_info_bottom_item" v-for="(item,i) in basCollect.slice(0,5)" :key="i" :to="`/bas/item/${item.id}`" :title="item.name">
              ...
              <RouterLink to="/member/bas" class="user_info_bottom_item" v-if="basCollect.length>4">
                <div class="user_info_bttom_item_2">
                  更多
                </div>
              </RouterLink>
