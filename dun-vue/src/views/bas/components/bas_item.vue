...
import {getBaContents,basSearch,getBaEssence,addbaCollect,delbaCollect} from '@/api/bas'
...
export default {
    ...
    setup(){
        ...
        // 吧所属帖子列表
        const getlist=()=>{
            getBaContents({query:route.params.id,pagenum:pagination.pagenum,pagesize:pagination.pagesize }).then(data=>{
        ...
        return{contents,source,bastext,baEssence,handleCurrentChange,ba_botton,ba_show,pagination}
    }
}
</script>
